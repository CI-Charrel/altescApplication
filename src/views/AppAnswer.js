    ...
    <AppContainer>
      <View style={AppStyle.mainscreen}>
        <View style={AppStyle.askHeader}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("AppAskUs")}
          >
        ...
        <View style={{ flex: 1, marginTop: 20 }}>
          <Text style={[AppStyle.fontMedium, { paddingBottom: 30 }]}>
            Q: {props.route.params.question}
          </Text>
          <View style={{ flexDirection: "row" }}>
            <Text style={AppStyle.fontMedium}>A: </Text>
            <Text style={[AppStyle.fontMedium, { marginRight: 32 }]}>
              {" "}
              {props.route.params.answer}{" "}
            </Text>
          </View>
        </View>
        ...
        <View style={{ flex: 1 }}>
          <TouchableOpacity
            onPress={() => props.navigation.navigate("AppContact")}
          >
            <Text style={AppStyle.fontMedium}>
