...
const QuestionAnswer = (props) => {
  ...
  const answ =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris vehicula cursus purus at pulvinar. Integer molestie elit egestas maximus ultricies. Sed auctor tempor ligula. Nulla imperdiet mauris et enim tempor, et scelerisque ligula facilisis. Interdum et malesuada fames ac ante ipsum primis in ";
  ...
  for (let index = 0; index < array.length; index++) {
    var cmp = (
      <TouchableOpacity
        key={index}
        onPress={() =>
          props.navigation.navigate("AppAnswer", {
